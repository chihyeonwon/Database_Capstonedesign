...
회원가입 페이지(joinActivity)같은 경우에는 로그인 페이지(loginActivity최상단 UI 생성
![image](https://github.com/wonttan/Mobile_Programming/assets/58906858/97fbcf24-dd36-4247-bd19-c1d088ea8196)
```
